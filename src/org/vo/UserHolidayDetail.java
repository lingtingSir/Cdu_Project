...
/**
 * UserHolidayDetail entity. @author MyEclipse Persistence Tools
 */

public class UserHolidayDetail implements java.io.Serializable {
	...
	/** default constructor */
	public UserHolidayDetail() {
	}

	/** full constructor */
	public UserHolidayDetail(Users users, Integer integralChange,
			String changeDes) {
		this.users = users;
